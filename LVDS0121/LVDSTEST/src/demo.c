...
//				xil_printf("\n\r");
		...
		memset(recvbuf1,0,20);
		memset(recvbuf2,0,20);
		memset(recvbuf3,0,20);
		memset(recvbuf4,0,20);
		memset(recvbuf5,0,20);
		memset(recvbuf6,0,20);
		memset(recvbuf7,0,20);
		memset(recvbuf8,0,20);
		memset(recvbuf9,0,20);
		memset(recvbuf10,0,20);
